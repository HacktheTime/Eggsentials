...
import de.hype.eggsentials.fabric.screens.BBsentialsConfigScreenFactory;
...
import static de.hype.eggsentials.client.common.client.BBsentials.*;
import static de.hype.eggsentials.client.common.objects.WaypointRoute.waypointRouteDirectory;
                                    ...
                                    .then(ClientCommandManager.argument("className", StringArgumentType.string())
                                            ...
                                            .then(ClientCommandManager.argument("variableName", StringArgumentType.string())
                                                    .suggests((context, builder) -> {
                                                        ...
                                                        try {
                                                            variableNames = List.of(Chat.getVariableNames("de.hype.eggsentials.client.common.config", StringArgumentType.getString(context, "className")));
                                                        } catch (Exception e) {
