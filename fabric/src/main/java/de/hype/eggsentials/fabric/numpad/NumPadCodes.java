...
import de.hype.eggsentials.fabric.screens.RoutesConfigScreen;
import de.hype.eggsentials.fabric.screens.WaypointsConfigScreen;
...
import static de.hype.eggsentials.environment.packetconfig.PacketUtils.gson;
...
public class NumPadCodes {
    ...
    public NumPadCodes() {
        ...
        KeyBinding enterKey = new KeyBinding("Enter", GLFW.GLFW_KEY_KP_ENTER, "eggsentials.numpad");
        KeyBinding clear = new KeyBinding("Clear", GLFW.GLFW_KEY_KP_ADD, "eggsentials.numpad");
        KeyBinding remove = new KeyBinding("Remove", GLFW.GLFW_KEY_KP_DECIMAL, "eggsentials.numpad");
        Thread t = new Thread(() -> {
            while (true) {
