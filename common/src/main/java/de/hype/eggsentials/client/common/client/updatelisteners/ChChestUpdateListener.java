...
import de.hype.eggsentials.shared.packets.mining.ChestLobbyUpdatePacket;
...
public class ChChestUpdateListener extends UpdateListener {
    ...
    public void setWaypoints() {
        ...
        for (ChChestData chest : lobby.chests) {
            ...
            chestItems.forEach((item) -> renderInformationList.add(new RenderInformation("eggsentials", "textures/gui/sprites/waypoints/" + item + ".png")));
